...
object AllSettings : SettingsRegistry() {
    ...
    /**
     * RAM dolduğunda otomatik ZRAM/Swap kullanımını etkinleştirir.
     * Etkinleştirildiğinde, yüksek RAM gerektiren modlar (fizik modu vb.)
     * çalışırken uygulama çökmez - cihazın ZRAM/swap alanını kullanır.
     */
    val enableSwapMemory = boolSetting("enableSwapMemory", false)
